...
public class GoatSoldier extends Goat {
    ...
    // Setting spawn location & attributes
    ...
    public GoatSoldier(Level level, Location loc) {
        ...
        this.setCustomName(Component.Serializer.fromJson(
                "{\"text\":\"" + "Soldier Goat" + " (" + "50" + "/" + "50 " + ChatColor.RED + "♥" + ChatColor.WHITE + " )" + "\"}"
        ));
        this.setCustomNameVisible(true);

    }

    //Updating the custom name for when the Soldier Goat is damaged
    ...
    //Adding actions to the goat (attack mobs)
